...
from beta2s_array import curve
import csv
import glob
...
d3pa_3 = 0
Cj3 = 0 
fRsi = 0#0.043#0.03409082702482847  # fractional contribution of Raman in silicon
...
figstoshow = {'Figure1': 1, 'Figure2': 1, 'Figure3': 1, 'Figure4': 0, 'Figure5': 0}

M = 2 ** 12               # number of steps in z
...
att_dB_over_cm = 2.65 #+ (2.4 - carr) / 0.85 * 2
n2 = 1.351e-17
...
tpa = 4.34e-12
t4pa = 0#3.6e-41
fa = 0     # turns fca on/off
fd = 0     # turns fcd on/off
dtpa = 2.378e-14 / 2 * 100
# fixed parameters
...
"""Mode overlaps"""
R11=1 / 0.07e-12 #1.7884096685500957e-13 # not used, naive value assuming zero z-component of modal field
...
beta2 = -3.3558558559E-24 * 1e24
beta3 = -8.1918334939E-40 * 1e36

beta4 = 1.9402794024E-52 * 1e48#-2.6671732822827566e-5 #-4.081352915829911e-5
beta5 = -8.3001980659E-66 * 1e60#7.740634783138472e-7
beta6 = 2.9242676094E-79 * 1e72#-1.130376215162516e-8
beta7 = -9.3428016521E-93 * 1e84#1.262298363451786e-10
beta8 = -5.9887152202E-107 * 1e96#-3.081409500391959e-13
beta9 = 2.4907905254E-119 * 1e108#-4.489874605017346e-14
beta10 = -6.6136822641E-133 * 1e120 #2.000814953490767e-15
beta11 = -6.0378029463E-146 * 1e132#-5.440777102870384e-17
...
C = 0#0.78135485849231634 #1.2 chirp parameter
